...
data.create_csv_mail(folder_path+file_name+"_no_translated.csv", addr, mdp, mails_to_copy=100) # Create mail database in a csv file of 100 mails in the mailbox
